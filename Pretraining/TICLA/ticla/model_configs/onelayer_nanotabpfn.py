...
class GeneralConfig:
    name: str = "nanotabpfn"
    variant: str = "onelayer_nanotabpfn"
    class_name : str = "OneLayerNanoTabPFN"
    weights_path : str = os.path.abspath(os.path.dirname(inspect.getfile(ticla)) + "/../../../") + "/FoundationModels/weights/NanoTabPFN/nanotabpfn.pth"
...
class CheckpointConfig:
    dir: Optional[str] = "./workdir/onelayer_nanotabpfn/checkpoint/dir"
...
class WandbConfig:
    log: bool = True
    project: str = "TICLA"
    name: Optional[str] = "OneLayerNanoTabPFN"
