    ...
    def disabling_layer_config(t, m):
        ...
        for layer in range(3):
            if m == layer and t == "col":
                col_layers_info.append(( layer ,  {"attn1":{"w_attn_on_query": 0.0, "w_attn_on_support": 0.0, "w_ffn_on_support":0.0, "w_ffn_on_query": 0.0}, 
                "attn2":{"w_attn_on_query": 0.0, "w_attn_on_support": 0.0, "w_ffn_on_support":0.0, "w_ffn_on_query": 0.0}} ))
            else:
        ...
        for layer in range(3):
            if m == layer and t == "row":
                row_layers_info.append(( layer ,  {"w_attn_on_query": 0.0, "w_attn_on_support": 0.0, "w_ffn_on_support":0.0, "w_ffn_on_query": 0.0} ))
            else:
        ...
        for layer in range(12):
            if m == layer and t == "predictor":
                predictor_layers_info.append(( layer ,  {"w_attn_on_query": 0.0, "w_attn_on_support": 0.0, "w_ffn_on_support":0.0, "w_ffn_on_query": 0.0} ))
            else:
