...
config_base["model_parameters"] = {"model_path" : str(Path(__file__).resolve().parents[3]) + "/FoundationModels/weights/Limix/LimiX-16M.ckpt", 
...
for layer in range(number_of_layers):
    layers_info.append(
            (
                ...
                "w_mlp_on_query": 1.0,
                "w_second_attn_features_on_query": 1.0,
                "w_second_attn_features_on_support": 1.0, 
                "w_second_mlp_on_support":1.0,
                "w_second_mlp_on_query": 1.0,
                "w_attn_sequence_on_query": 1.0,
                "w_attn_sequence_on_support": 1.0,
                "w_third_mlp_on_support":1.0,
                "w_third_mlp_on_query": 1.0
                },
            )
        )
