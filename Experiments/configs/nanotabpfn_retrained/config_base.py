...
number_of_layers = 6
config_base = {}
config_base["model"] = "nanotabpfn_retrained"
...
config_base["model_parameters"] = {"model_path":  str(Path(__file__).resolve().parents[3]) + "/FoundationModels/weights/NanoTabPFN/retrained_nanotabpfn.ckpt",
