    ...
    def forward(self, x: torch.Tensor, 
        ...
        if calculate_sample_attention or calculate_feature_attention:
            return self.transformer_encoder(embedded_all, feature_atten_mask=None, eval_pos=eval_pos,
                                            ...
                                            calculate_feature_attention=calculate_feature_attention, layers_info = layers_info, **kwargs)
        else:
            pass
        encoder_out = self.transformer_encoder(embedded_all, feature_atten_mask=None, eval_pos=eval_pos, layers_info = layers_info, **kwargs)[0]
