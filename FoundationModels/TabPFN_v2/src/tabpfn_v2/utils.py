...
from tabpfn_v2.misc._sklearn_compat import check_array, validate_data

if TYPE_CHECKING:
    from sklearn.base import TransformerMixin
    from sklearn.pipeline import Pipeline

    from tabpfn_v2.classifier import TabPFNClassifier, XType, YType
...
def _get_embeddings(
    ...
    from tabpfn_v2.preprocessing import ClassifierEnsembleConfig, RegressorEnsembleConfig
