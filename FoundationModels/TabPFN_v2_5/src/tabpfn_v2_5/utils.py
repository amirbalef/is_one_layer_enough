...
from tabpfn_v2_5.misc._sklearn_compat import check_array, validate_data
...
if TYPE_CHECKING:
    ...
    from tabpfn_v2_5.classifier import TabPFNClassifier, XType, YType
...
def get_embeddings(
    ...
    from tabpfn_v2_5.preprocessing import (  # noqa: PLC0415
